...
public class PanelDatosPersonales extends JPanel {
	...
	public PanelDatosPersonales() {
		...
		btnBorrar.setIcon(new ImageIcon(PanelDatosPersonales.class.getResource("/tablaEstudiante/res/eliminar.png")));
...
//
	...
	private JPopupMenu getPopUpMenu() {
		...
		if (imagenEnArrayDeBytes != null) {
			...
			menu.add("Dimensiones: " + imagen.getIconWidth() + "x" + imagen.getIconHeight() + " píxeles");
			menu.addSeparator();
		}
	...
	public void setImagen(byte[] imagen) {
		if (imagen != null && imagen.length > 0) {
			...
			if (icono.getIconHeight() > 100 || icono.getIconWidth() > 100) {
				JOptionPane.showMessageDialog(null, "La imagen debe tener unas " + "dimensiones máximas de 100x100 "
